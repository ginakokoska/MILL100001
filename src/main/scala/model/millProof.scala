...
//    var rVar = false
    ...
    tmp match {
      case "01" =>
        for(i <- 0 to 2) {
          if(grid.gridList(i)(pos1)(pos2).isColor.contains(color) ||
            grid.gridList(sq)(0)(i).isColor.contains(color)) count = count + 1
          else {
            count = 0
          }
        }
      case "10" =>
        for(i <- 0 to 2) {
          if(grid.gridList(i)(pos1)(pos2).isColor.contains(color) ||
            grid.gridList(sq)(i)(0).isColor.contains(color)) count = count + 1
          else {
            count = 0
          }
        }
      case "12" =>
        for(i <- 0 to 2) {
          if(grid.gridList(i)(pos1)(pos2).isColor.contains(color) ||
            grid.gridList(sq)(i)(2).isColor.contains(color)) count = count + 1
          else {
            count = 0
          }
        }
      case "21" =>
        for(i <- 0 to 2) {
          if(grid.gridList(i)(pos1)(pos2).isColor.contains(color) ||
            grid.gridList(sq)(2)(i).isColor.contains(color)) count = count + 1
          else {
            count = 0
          }
        }
